...
I learned how to use fetch API and filter the data coming from API

### Continued development

VANILLA JS, REACT.js and others

### Useful resources

- <a href="https://api.adviceslip.com/">Advice Slip JSON API</a> - This API is used in the project in order to display random advice.</a>
